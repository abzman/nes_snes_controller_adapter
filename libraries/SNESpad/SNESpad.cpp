...
// constructor
SNESpad::SNESpad(int strobe, int clock, int data, int data2)
  : m_strobe (strobe), m_clock (clock), m_data (data), m_data2 (data2)
  {
...
int SNESpad::shiftin(int which)
{
  int ret = digitalRead(m_data);
  int ret2 = digitalRead(m_data2);
  delayMicroseconds(12);
